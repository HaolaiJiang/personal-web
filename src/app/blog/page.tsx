        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="space-y-10">
                {allPostsData.length > 0 ? (
                    allPostsData.map(({ id, slug, date, title, description, excerpt }) => (
                        <article key={id} className="flex flex-col group">
                            ...
                            <Link href={`/blog/${slug}`} className="text-primary font-medium hover:text-accent inline-flex items-center transition-colors">
